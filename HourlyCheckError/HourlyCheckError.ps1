...
HourlyErrorCheck -Site SCHOOLVM -HostName PEGFEQAV -HostNumber "15,16" -DatabaseName "" -Subject "Non-Prod 5.14.2 School VM Hourly Summary" -EmailTo $REMAIL -EmailCC "" -IISLogFile "W3SVC1"
HourlyErrorCheck -Site SCHOOLVM -HostName PEGFEQAV -HostNumber "12,13" -DatabaseName "" -Subject "Non-Prod 5.15 School VM Hourly Summary" -EmailTo $REMAIL -EmailCC "" -IISLogFile "W3SVC1"
HourlyErrorCheck -Site HEDVM -HostName PEGFEQAV -HostNumber "10,11" -DatabaseName "" -Subject "Non-Prod 5.14.2 HED VM Hourly Summary" -EmailTo $REMAIL -EmailCC "" -IISLogFile "W3SVC"
HourlyErrorCheck -Site HEDVM -HostName PEGFEQAV -HostNumber "17,18" -DatabaseName "" -Subject "Non-Prod 5.15 HED VM Hourly Summary" -EmailTo $REMAIL -EmailCC "" -IISLogFile "W3SVC1"
