...
ErrorSummary -Site SCHOOL -HostName PEGFEQAV -HostNumber "12,13" -DatabaseName "" -Title "5.14 School VM Error summary" -EmailTo $MYMAIL -RollUpTo ""
ErrorSummary -Site HEDVM -HostName PEGFEQAV -HostNumber "10,11" -DatabaseName "" -Title "5.14 HED VM Error summary" -EmailTo $MYMAIL -RollUpTo ""
